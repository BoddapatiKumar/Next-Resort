...
const DynamicProduct = () => {
  ...
  return (
    <div>
        <UserNavigation />
        <CalenderComponent />
       <div className="d-flex p-5 m-2 bg-amber-100 min-vh-100" style={{ gap: '20px' }}>
            ...
            <div className="d-flex flex-column justify-content-start" style={{ flex: '1', overflowWrap: 'break-word' }}>
                ...
                <div className="d-flex justify-content-center gap-3 mt-5">
                    ...
                    <Link href="/" className="btn btn-danger w-40">Go Back</Link>
                </div>
            </div>
        </div>
    </div>
